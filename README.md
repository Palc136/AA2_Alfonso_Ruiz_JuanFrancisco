...
Este proyecto es una aplicación fue desarrollada para la 
...
1. Abre tu gestor de MySQL.opcion1: 
2. Crea la base de datos: CREATE DATABASE cineplus_db;
3. Selecciona la base de datos: USE cineplus_db;
4. copia y pega la consulta de archivo "database-script.sql"
5. opcion 2:
6. Importa y ejecuta el archivo "database-script.sql" incluido en 
   el proyecto. Este creará las tablas (Actor, peliculas, etc.) 
   e insertará los datos iniciales.

PASO B: CONFIGURACIÓN Y EJECUCIÓN DEL BACKEND (NetBeans)
1. Abre el proyecto backend(juanAlfonsomi-backend) en NetBeans o una herramienta que tambien pueda abrir el proyecto web.
...
PASO C: EJECUCIÓN DEL FRONTEND 
1. Abre una terminal en la carpeta raíz del proyecto frontend (proyectofront-end_back-end-main).
...
=======================================================================
Desarrollado como proyecto académico - Ingeniería de Software.
=======================================================================
